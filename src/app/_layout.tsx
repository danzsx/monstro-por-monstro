...
export default function Layout() {
  ...
  return <SafeAreaProvider><AppProvider><StatusBar style="dark" /><Shell><Stack screenOptions={{ headerShown: false, animation: 'none', contentStyle: { backgroundColor: '#FCF8F4' } }}><Stack.Screen name="index" options={{ title: 'Seu próximo monstro' }} /><Stack.Screen name="onboarding" options={{ title: 'Seu ponto de partida' }} /><Stack.Screen name="diagnostic" options={{ title: 'Diagnóstico inicial' }} /><Stack.Screen name="battle" options={{ title: 'Sua batalha' }} /><Stack.Screen name="bestiary" options={{ title: 'Meu bestiário' }} /><Stack.Screen name="monster" options={{ title: 'Conheça seu monstro' }} /><Stack.Screen name="profile" options={{ title: 'Meu perfil' }} /></Stack></Shell></AppProvider></SafeAreaProvider>;
}
