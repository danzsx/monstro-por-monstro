...
import { House, BookOpen, UserRound, ArrowUpRight, Sparkles, CloudOff } from 'lucide-react-native';
import { useApp } from '@/data/provider';
import { colors as c } from './theme';
import { Txt } from './primitives';
const nav = [{ href: '/' as const, label: 'Meu próximo monstro', short: 'Início', Icon: House }, { href: '/bestiary' as const, label: 'Meu bestiário', short: 'Bestiário', Icon: BookOpen }, { href: '/profile' as const, label: 'Meu perfil', short: 'Perfil', Icon: UserRound }];
