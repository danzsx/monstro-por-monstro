...
const monsters: Record<string, any> = {
  ...
  'cell-origin': require('../../assets/monsters/cytology.png'),
  biotechnology: require('../../assets/monsters/genetics.png'),
  immunity: require('../../assets/monsters/genetics.png'),
  cancer: require('../../assets/monsters/cytology.png'),
  mutations: require('../../assets/monsters/genetics.png'),
  'population-genetics': require('../../assets/monsters/genetics.png'),
  'living-beings': require('../../assets/monsters/cytology.png'),
  taxonomy: require('../../assets/monsters/genetics.png'),
  'life-cycles': require('../../assets/monsters/genetics.png'),
